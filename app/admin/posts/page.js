      ...
      <AdminLayout>
        ...
        <div className="flex flex-col gap-6">
          <div className="flex justify-end">
            <a class="inline-flex items-center justify-center rounded-md bg-primary px-10 py-2 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10 w-32" href="/admin/posts/new">Nuevo</a>
          </div>
